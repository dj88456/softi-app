...
export default function Home() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8">
      ...
      <Link
        to="/view"
        className="block w-full mb-6 rounded-lg bg-indigo-700 hover:bg-indigo-600 text-white text-center py-3 px-5 shadow transition"
      >
        <div className="text-lg font-bold tracking-tight">BTS SOFTI REPORT</div>
        <div className="text-indigo-200 text-xs mt-0.5">View this week's published team reports →</div>
      </Link>
