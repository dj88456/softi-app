    ...
    <div className={`rounded-xl border ${meta.border} ${meta.bg} p-4 mb-3`}>
      ...
      <div className="flex gap-2 items-start">
        ...
        <button
          onClick={add}
          disabled={!draft.trim()}
          className={`px-5 py-2.5 rounded-lg text-base font-semibold transition flex-shrink-0 ${
        ...
        <button
          onClick={openInput}
          className={`mt-1 px-4 py-2 rounded-lg text-sm font-semibold ${meta.badge} text-white hover:opacity-90 transition`}
        >
          + Add
        </button>
      )}
